      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        <section className="lg:col-span-2 space-y-6">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full py-2 bg-primary hover:bg-primary-hover text-primary-text transition-all duration-200 rounded-lg text-xs font-bold uppercase tracking-widest active:scale-95"
            >
              保存原子习惯
            </button>
          </form>
              ...
              <form onSubmit={handleSendMagicLink} className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="bg-primary hover:bg-primary-hover text-black px-3 py-1.5 rounded-lg text-[10px] font-bold transition-all duration-200 uppercase tracking-wider flex items-center gap-1 active:scale-95"
                  >
                    {isSendingLink ? (
            ...
            <div className="pt-3 border-t border-border-subtle/50 space-y-3">
              ...
              {isSyncing ? (
                ...
                <button
                  ...
                  className="w-full py-2 bg-surface-3 hover:bg-primary hover:text-black transition-all duration-200 rounded-lg text-[10px] font-bold uppercase tracking-wider flex items-center justify-center gap-1.5 border border-border-subtle active:scale-95"
                >
