      ...
      <div className="min-h-16 py-3 md:py-0 border-b border-border-subtle bg-surface-1/40 px-4 md:px-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 relative z-10">
        ...
        {isTrainingActive ? (
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-error/50 hover:bg-error/10 text-xs font-semibold text-error transition-all duration-200 active:scale-95"
          >
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto">
            ...
            <button
              ...
              className="bg-primary hover:bg-primary-hover text-primary-text text-xs font-bold px-4 h-8 rounded-lg flex items-center justify-center gap-1 transition-all duration-200 active:scale-95"
            >
              <span>启动演练</span>
                ...
                {msg.coachFeedback && (
                  <SpotlightCard spotlightColor="rgba(59, 130, 246, 0.15)" className="mt-4 border border-border-subtle rounded-lg p-3 space-y-3">
                    ...
                    <button
                      ...
                      className="w-full py-1.5 bg-surface-3 hover:bg-primary hover:text-primary-text transition-all duration-200 rounded-lg text-[10px] font-bold uppercase tracking-widest flex items-center justify-center gap-1 active:scale-95"
                    >
      ...
      <div className="p-4 border-t border-border-subtle bg-surface-1 relative z-10">
        <form onSubmit={handleSendMessage} className="flex gap-2">
          <input
            ...
            className="flex-1 px-4 py-2.5 bg-surface-1 border border-border-subtle rounded-lg text-xs outline-none focus:border-primary text-text-primary placeholder:text-neutral-gray"
          />
          <button
            type="submit"
